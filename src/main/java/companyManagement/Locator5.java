...
public class Locator5 extends BasePage{
	...
	private static WebElement Mya23 = null;
	...
	//Status Wise Summery Complied-Pie chart
	 ...
	 //Grey Graph green-Not Applicable
	 ...
	 //  Not Complied
	   ...
	   private static WebElement PWAuditStatusSummerABCConstructionClosed = null;
	   private static WebElement PendingReviewCircle = null;
	...
	//	private static WebElement RiskNADDMedium1 = null;
		...
		private static WebElement PWCSSubContractorProjectDD1 = null;
		...
		private static WebElement May23 = null;

		
		private static WebElement Feb23 = null;
		private static WebElement Feb231 = null;
		

		private static WebElement RudraHeritage = null;

		private static WebElement Triangle = null;
		private static WebElement TriangleColumn = null;
		private static WebElement Type = null;
		private static WebElement SubContractorDD = null;
		...
		{
			Projectnametext = getDriver().findElement(By.xpath("//div[@class='k-animation-container']//li[position()=1]/div/span[.='Chandragan Construction ']"));
	...
	//Contractor Type Wise-Compliance Status Summery
...
//Contractor Type Wise-Audit Status Summery
		...
		{
			CTWCompletedGreen = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[25]"));
		...
		{
			CTWOverdueRed = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[36]"));
		...
		{
			CTWPendingReviewYellow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[47]"));
		...
		//Project Wise Compliance Status Summery

		
		public static WebElement PWCSSABCConstructionComplied()		//Method for searching Username input
		{
			PWCSSABCConstructionComplied = getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[4]//*[name()='text' and @class='highcharts-drilldown-axis-label']//*[name()='tspan' and .='Ecobuild Solutions']"));
		...
		{
			PWCSSABCConstructionCompliedHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[55]"));
		...
		{
			PWCSSABCConstructionCompliedMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[56]"));
		...
		{
			PWCSSABCConstructionCompliedLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[57]"));
...
//Not Complied
		...
		{
			PWCSSABCconstructionNotCompliedHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[58]"));
		...
		{
			PWCSSABCconstructionNotCompliedMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[59]"));
		...
		{
			PWCSSABCconstructionNotCompliedLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[60]"));
...
//Not Applicable
		...
		{
			PWCSSABCconstructionNotApplicableHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[61]"));
		...
		{
			PWCSSABCconstructionNotApplicableMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[62]"));
		...
		{
			PWCSSABCconstructionNotApplicableLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[63]"));
	...
	//Project Wise Audit Status Summery
				...
				public static WebElement PendingReviewCircle()		//Method for searching Username input
				{
					PendingReviewCircle = getDriver().findElement(By.xpath("(//*[@class='highcharts-legend-item highcharts-column-series highcharts-color-undefined highcharts-series-2'])[4]"));
					return PendingReviewCircle;
		...
		{
			PWAuditStatusSummeryABCConstructionOverdue = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[86]"));
		...
		{
			PWAuditStatusSummerABCConstructionPendingReview = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[113]"));
		...
		{
			PWAuditStatusSummerABCConstructionClosed = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[59]"));
    ...
    public static WebElement DocumentSelectLocationDrop()		//Method for searching Username input
   	{
    	DocumentSelectLocationDrop = getDriver().findElement(By.xpath("(//div[@class='k-animation-container']//div//span[@class='k-icon k-i-expand'])[1]"));
    ...
    public static WebElement DocumentSelectLocationDropDown()		//Method for searching Username input
   	{
    	DocumentSelectLocationDropDown = getDriver().findElement(By.xpath("(//div[@class='k-animation-container']//div//ul | span[@class='k-icon k-i-expand'])[1]"));
    ...
    public static WebElement DocumentSelectContractor()		//Method for searching Username input
   	{
    	DocumentSelectContractor = getDriver().findElement(By.xpath("//span[.='Select Contractor']"));
    ...
    public static WebElement DocumentSelectProjectDropDown()		//Method for searching Username input
   	{
    	DocumentSelectProjectDropDown = getDriver().findElement(By.xpath("//span[.='Creation Construction']"));
	...
	{
		SelectMonthDD = getDriver().findElement(By.xpath("//div[@class='k-animation-container']//li[.='Jan 24']"));
		return SelectMonthDD;
		
		
	}
	
	public static WebElement Facility()		//Method for searching Username input
	{
		SelectMonthDD = getDriver().findElement(By.xpath("//*[@id='divReportss']/div/div[2]"));
		return SelectMonthDD;
    ...
    public static WebElement ProjectDrop()		//Method for searching Username input
   	{
    	ProjectDrop = getDriver().findElement(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr[1]/td[1]"));
   	 return ProjectDrop;
   	}
    ...
    public static WebElement Mya23()		//Method for searching Username input
   	{
    	Mya23 = getDriver().findElement(By.xpath("//span[.='May 23']"));
   	 return Mya23;
   	}
	...
	{
		Project = getDriver().findElement(By.xpath("//*[@id='MainContentCL']/div[3]/div[1]"));
	return Project;
    }
	...
	{
		Project2 = getDriver().findElement(By.xpath("(//span[.='ABC Construction'])[3]"));
	return Project2;
    }
	...
	{
		Project3 = getDriver().findElement(By.xpath("(//div[@class='k-widget k-dropdowntree k-dropdowntree-clearable'])[2]"));
	return Project3;
    }
	...
	{
		ClosedProject = getDriver().findElement(By.xpath("//span[.='ABC Construction']"));
	...
	{
		ClosedProjecttext = getDriver().findElement(By.xpath("//div[@class='k-animation-container']//li[position()=8]/div/span[.='Yash Heritage']"));
	...
	{
		PWSCompliedGraph1 = getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[3]//*[name()='text' and @class='highcharts-drilldown-axis-label']//*[name()='tspan' and .='ABC Construction']"));
	...
	{
		CTWOverdueRed1 = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[3]"));
	...
	{
		PWCSSubContractorComplied = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined highcharts-drilldown-data-label'])[22]"));
	...
	{
	PWCSSubContractorCompliedHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[136]"));
	...
	{
		PWCSSubContractorCompliedMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[137]"));
	...
	{
		PWCSSubContractorCompliedLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[138]"));
	...
	{
		PWCSSubContractorNotComplied = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined highcharts-drilldown-data-label'])[23]"));
	...
	{
		PWCSSubContractorNotCompliedHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[139]"));
	...
	{
		PWCSSubContractorNotCompliedMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[140]"));
	...
	{
		PWCSSubContractorNotCompliedLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[141]"));
	...
	{
		PWCSSubContractorNotApplicable = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined highcharts-drilldown-data-label'])[24]"));
	...
	{
		PWCSSubContractorNotApplicableHigh = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[142]"));
	...
	{
		PWCSSubContractorNotApplicableMedium = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[143]"));
	...
	{
		PWCSSubContractorNotApplicableLow = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[144]"));
	...
	public static WebElement PWCSSubContractorProjectDD1()		//Method for searching Username input
	{
		PWCSSubContractorProjectDD1 = getDriver().findElement(By.xpath("//div[@class='k-animation-container']//ul//li[position()=2]/div/span[.='Creation Construction']"));
		return PWCSSubContractorProjectDD1;
	...
	{
		PWCSSubContractorContractorTypeDD1 = getDriver().findElement(By.xpath("(//span[.='Sub-Contractor'])[1]"));
	...
	{
		DownloadAndViewButton = getDriver().findElement(By.xpath("(//a[@class='k-button k-button-icontext ob-download k-grid-docView'])[2]"));
	...
	{
		Period3 = getDriver().findElement(By.xpath("//span[.='Feb 21']"));
		return Period3;
	...
	public static WebElement May23()		//Method for searching Username input
	{
		May23 = getDriver().findElement(By.xpath("//span[.='May 23']"));
		return May23;
		
		
	}

	public static WebElement Jun22()		//Method for searching Username input
	{
		Feb23 = getDriver().findElement(By.xpath("//span[.='Jun 22']"));
	return Feb23;
    }
	...
	{
		Feb23 = getDriver().findElement(By.xpath("//span[.='Jan 23']"));
	return Feb23;
    }
	
	
	
	public static WebElement Feb231()		//Method for searching Username input
	{
		Feb231 = getDriver().findElement(By.xpath("//span[.='Feb 23']"));
	return Feb231;
    }
	
	
	public static WebElement Sep22()		//Method for searching Username input
	{
		Feb231 = getDriver().findElement(By.xpath("//span[.='Sep 22']"));
	return Feb231;
    }
	...
	{
		RudraHeritage = getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[6]//*[name()='text' and @class='highcharts-drilldown-axis-label']//*[name()='tspan' and .='Ecobuild Solutions']"));
	...
	public static WebElement Triangle()		//Method for searching Username input
	{
		Triangle = getDriver().findElement(By.xpath("(//span[@class='k-icon k-i-more-vertical'])[3]"));
		return Triangle;
	...
	public static WebElement TriangleColumn()		//Method for searching Username input
	{
		TriangleColumn = getDriver().findElement(By.xpath("(//div[@class='k-animation-container']//ul//li[position()=4]/span[.='Columns'])[1]"));
	...
	public static WebElement Type()		//Method for searching Username input
	{
		Type = getDriver().findElement(By.xpath("(//div[@class='k-animation-container']//ul//li[position()=4]/span[.='Type'])[1]"));
		return Type;
	...
	public static WebElement SubContractorDD()		//Method for searching Username input
	{
		SubContractorDD = getDriver().findElement(By.xpath("//div[@class='k-animation-container']//ul//li[position()=2]/div/span[.='Sub-Contractor']"));
	...
	{
		SubContractorDD = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[9]"));
		return SubContractorDD;
	...
	{
		SubContractorDD = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[16]"));
		return SubContractorDD;
