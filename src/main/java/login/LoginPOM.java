...
public class LoginPOM extends BasePage{
	...
	{
		pass =getDriver().findElement(By.xpath("//*[@id='txtpass']"));
		return pass;
	}
	...
	public static WebElement clickSecreterial()		//Method for searching Compliance image
	{
		//comp_img = getDriver().findElement(By.xpath("//div[@id='dvbtnCompliance']/div[1]/img"));
		comp_img = getDriver().findElement(By.xpath("//*[@id='dvbtnSecretarial']"));
		return comp_img;
	}
